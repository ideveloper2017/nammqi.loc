...
class CounterupTable extends TableAbstract
{
    ...
    /**
     * CounterupTable constructor.
     * @param DataTables $table
     * @param UrlGenerator $urlGenerator
     * @param CounterupInterface $counterupRepository
     */
    public function __construct(DataTables $table, UrlGenerator $urlGenerator, CounterupInterface $counterupRepository)
    {
        parent::__construct($table, $urlGenerator);

        $this->repository = $counterupRepository;

        if (!Auth::user()->hasAnyPermission(['counterup.edit', 'counterup.destroy'])) {
    ...
    {
        return $this->addDeleteAction(route('counterup.deletes'), 'counterup.destroy', parent::bulkActions());
    }
