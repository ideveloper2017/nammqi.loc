                ...
                <div class="blog-items">
                    ...
                    <div class="blog-item blog-item-wide">
                        <div class="blog-image">
                            <a href="{{ $post->url }}"><img src="{{ RvMedia::getImageUrl($post->image, 'thumb', false, RvMedia::getDefaultImage()) }}" alt="blog image" class="img-responsive" style="width:370px;height:300px;"></a>
                        </div>
