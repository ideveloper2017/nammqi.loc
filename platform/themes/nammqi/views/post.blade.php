            ...
            <div class="col-md-8 col-sm-12 col-xs-12">
                <div class="single-post">
                    ...
                    <div class="post-content">
                        ...
                        <ul class="post-meta">
                            <li><span
                                    class="icon flaticon-calendar"></span>{{ $post->created_at->translatedFormat('M d, Y') }}
                            </li>
                            @if (!$post->categories->isEmpty())
                                <li><span class="icon flaticon-student"></span><a
                                        href="{{ $post->firstCategory->url }}">{{ $post->firstCategory->name }}</a></li>
                            @endif
                            @if ($post->author->username)
                                <li><span class="icon flaticon-people"></span>{{ $post->author->name }}</li>
                            @endif
                            <li><span class="icon flaticon-open-book-top-view"></span> <a
                                    href="#">{{ $post->views }}</a></li>
                        </ul>
                    ...
                    @foreach ($relatedPosts as $relatedItem)
                        <div class="col-md-6 col-sm-6 col-12">
                            <div class="post__relate-group @if ($loop->last) post__relate-group--right @endif">
                                <h4 class="relate__title">@if ($loop->first)
                                        {{ __('Previous Post') }}
                                    @else
                                        {{ __('Next Post') }}
                                    @endif</h4>
